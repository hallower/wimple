            ...
            buttons[i].setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    switch (v.getId()) {
                        ...
                        case R.id.insert_pad_10:
                            cal.zero();
                            break;
                        case R.id.insert_pad_1:
                            cal.shift(1);
                            break;
                        case R.id.insert_pad_2:
                            cal.shift(2);
                            break;
                        case R.id.insert_pad_3:
                            cal.shift(3);
                            break;
                        case R.id.insert_pad_4:
                            cal.shift(4);
                            break;
                        case R.id.insert_pad_5:
                            cal.shift(5);
                            break;
                        case R.id.insert_pad_6:
                            cal.shift(6);
                            break;
                        case R.id.insert_pad_7:
                            cal.shift(7);
                            break;
                        case R.id.insert_pad_8:
                            cal.shift(8);
                            break;
                        case R.id.insert_pad_9:
                            cal.shift(9);
                            break;
                        case R.id.insert_pad_100:
                            cal.zeroTwice();
                            break;

                        case R.id.insert_pad_point:
                            cal.point();
                            break;
                        case R.id.insert_pad_plus:
                            cal.plus();
                            break;
                        case R.id.insert_pad_minus:
                            cal.minus();
                            break;
                        case R.id.insert_pad_multiply:
                            cal.multiply();
                            break;
                        case R.id.insert_pad_divide:
                            cal.divide();
                            break;
                        case R.id.insert_pad_eq:
                            cal.eq();
                            break;
                        case R.id.insert_pad_clear:
                            cal.clear();
                            break;
                        case R.id.insert_pad_back:
                            cal.shiftBack();
                            break;
                    }
                }
